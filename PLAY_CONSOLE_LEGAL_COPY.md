...
## 3) Data Safety Alignment Notes (internal)
- Data collection by developer: None
- Data sharing by developer: None
- Third-party ads SDKs: None
- Third-party analytics SDKs: None
- Account creation: None
- Data deletion: Users can uninstall app or clear app storage
- Payment processing: Google Play

## 4) Contact Block (paste into support page)
...
- Families target audience declarations
